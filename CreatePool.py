...
def create_pool(cursor, organisation_id, pool_name, parent_id):
    try:
...
def inherit_parent_users_into_pool(cursor, pool_id, parent_id):
    try:
...
def lambda_handler(event, context):
    try:
        ...
        with conn.cursor() as cursor:
            ...
            create_pool(cursor, organisation_id, pool_name, parent_id)
            pool_id = fetch_last_inserted_id(cursor)
            inherit_parent_users_into_pool(cursor, pool_id, parent_id)
