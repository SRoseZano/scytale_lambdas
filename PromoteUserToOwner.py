...
def promote_user_to_owner(cursor, organisation_id, user_id):
    try:
...
def demote_user_to_admin(cursor, organisation_id, login_user_id):
    try:
        logging.info("Executing SQL query promote user to admin")
...
def lambda_handler(event, context):
    try:
        ...
        with conn.cursor() as cursor:
            ...
            zanolambdashelper.helpers.is_user_org_owner(cursor,database_dict['schema'], database_dict['users_organisations_table'], login_user_id, organisation_id)
            ...
            promote_user_to_owner(cursor, organisation_id, user_id)
            demote_user_to_admin(cursor,organisation_id,login_user_id)
            conn.commit()
