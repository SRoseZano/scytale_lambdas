...
def lambda_handler(event, context):
    try:
        ...
        file_name = body_json.get('file_name')

        if not all([year, file_name]):
            raise Exception("Not all arguments provided")
        ...
        traceback.print_exc()
        status_value = 500
        body_value = 'Unable to get test pdf'
    ...
    return {
        'statusCode': 200,
        'body': 'Test pdf returned successfully',
        'url': presigned_url,
    }
